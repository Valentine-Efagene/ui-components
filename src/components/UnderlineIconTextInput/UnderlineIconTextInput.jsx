...
import styles from './UnderlineIconTextInput.module.css'

function UnderlineIconTextInput({
  id,
  className,
  style,
  name,
  ...
  return (
    <div htmlFor={id} className={`${styles.container} ${className}`}>
      ...
      <img src={icon} className={styles.labelIcon} alt="" />
      {value ? (
        <input
          style={
...
UnderlineIconTextInput.propTypes = {
  id: string,
  name: string,
  className: string,
  style: object,
...
UnderlineIconTextInput.defaultProps = {
  type: 'text',
  readOnly: false,
  required: false,
  name: null,
